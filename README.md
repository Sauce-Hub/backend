...
- [System Architecture \& App Flow](#-system-architecture--app-flow)
- [Project Directory Structure](#-project-directory-structure)
- [Database Schema \& Integrity](#-database-schema--integrity)
- [Installation \& Setup Guide](#-installation--setup-guide)
  - [Prerequisites](#prerequisites)
  - [Option A: Docker Compose (Recommended)](#option-a-docker-compose-recommended)
  - [Option B: Native / Local Environment](#option-b-native--local-environment)
  - [Environment Variables Configuration](#environment-variables-configuration)
- [API Usage \& Quickstart](#-api-usage--quickstart)
  - [Authentication Flow](#1-authentication-flow)
  - [API Endpoints Directory](#2-api-endpoints-directory)
  - [Postman Collection](#3-postman-collection)
  - [Key API Workflows (cURL Examples)](#4-key-api-workflows-curl-examples)
- [Testing \& Code Quality](#-testing--code-quality)
- [Documentation Index](#-documentation-index)
- [Contributing \& Architecture Rules](#-contributing--architecture-rules)
- [License](#-license)
...
- **🛡️ Strict Data Integrity**: PostgreSQL foreign keys with cascading deletions, custom database `CHECK` constraints, PHP 8 Backed Enums, and database transactions for all multi-table mutations.
...
Detailed specifications and decision records are maintained in the [`docs/`](file:///d:/Programming/Open_Sauce_IEEE_Final_Project/docs) directory:

- [`docs/00-project-overview.md`](file:///d:/Programming/Open_Sauce_IEEE_Final_Project/docs/00-project-overview.md) — High-level project scope and responsibilities.
- [`docs/01-database-schema.md`](file:///d:/Programming/Open_Sauce_IEEE_Final_Project/docs/01-database-schema.md) — Exact PostgreSQL schema, constraints, and relationships.
- [`docs/02-api-contract.md`](file:///d:/Programming/Open_Sauce_IEEE_Final_Project/docs/02-api-contract.md) — Complete REST API contract with request/response samples.
- [`docs/03-authentication.md`](file:///d:/Programming/Open_Sauce_IEEE_Final_Project/docs/03-authentication.md) — Sanctum token specs, guards, and security rules.
- [`docs/04-architecture-rules.md`](file:///d:/Programming/Open_Sauce_IEEE_Final_Project/docs/04-architecture-rules.md) — Layered architecture guidelines (Controllers, FormRequests, Services, Resources).
- [`docs/05-ai-integration.md`](file:///d:/Programming/Open_Sauce_IEEE_Final_Project/docs/05-ai-integration.md) — FastAPI AI microservice communication protocol.
- [`docs/07-decisions-log.md`](file:///d:/Programming/Open_Sauce_IEEE_Final_Project/docs/07-decisions-log.md) — Architecture and business decision log (DEC-001 through DEC-023).
- [`docs/08-current-status.md`](file:///d:/Programming/Open_Sauce_IEEE_Final_Project/docs/08-current-status.md) — Sprint progress, completed endpoints, and quality reports.
- [`docs/09-testing-strategy.md`](file:///d:/Programming/Open_Sauce_IEEE_Final_Project/docs/09-testing-strategy.md) — Testing guidelines and definition of done.

---

## 🤝 Contributing & Architecture Rules

When contributing to this repository, adhere strictly to the following standards:

1. **Thin Controllers**: All business logic and database transactions belong in dedicated `Services/`.
2. **Form Requests**: Non-trivial validation must reside in `Http/Requests/`.
3. **API Resources**: Responses must use dedicated `Http/Resources/` to preserve contract keys and avoid breaking mobile clients.
4. **Ownership Verification**: Never trust a client-provided `user_id`. Always verify ownership using `auth()->id()`.
5. **No Direct `main` Commits**: Always work in dedicated feature branches (`feature/...` or `docs/...`).
6. **Passing Tests Mandatory**: Every new feature or bugfix must be accompanied by passing automated feature tests.
